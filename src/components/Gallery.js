export default function Gallery() {
  return (
    <div>
      ...
      {/* Video End */}
      {/* Features-2 Start */}
      <div className="section features-section-2 section-padding">
        <div className="container">
          ...
          <div className="features-wrap-2">
            ...
            <div className="features-item-wrap">
              ...
              <div className="features-item-box features-box-1">
                <div className="features-item features-1">
              ...
              {/* Features Item Box Start */}
              <div className="features-item-box features-box-2">
                <div className="features-item features-3">
                  <div className="features-icon">
              ...
              {/* Features Item Box End */}
              {/* Features Item Box Start */}
              <div className="features-item-box features-box-3">
                <div className="features-item features-5">
                  <div className="features-icon">
